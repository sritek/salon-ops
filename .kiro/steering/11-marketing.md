---
# Marketing & Engagement module patterns - campaigns, WhatsApp/SMS/Email, offers, referrals, and feedback
inclusion: fileMatch
fileMatchPattern: '**/marketing/**/*.ts, **/campaign/**/*.ts, **/notification/**/*.ts'
---
