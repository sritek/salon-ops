---
# Billing & Invoicing module patterns - invoice creation, payments, GST, discounts, refunds, credit notes, cash drawer, and day closure
inclusion: fileMatch
fileMatchPattern: '**/billing/**/*.ts, **/invoice/**/*.ts, **/payment/**/*.ts, **/cash-drawer/**/*.ts'
---
